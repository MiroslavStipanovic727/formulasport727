...
import com.metropolitan.formulasport727.pages.Login;
...
//                requestedPageName);
    ...
    private boolean isAuthenticated() throws IOException {
        ...
        if (korisnik != null) {
            if (korisnik.getUloga()== Uloga.Administrator || korisnik.getUloga()== Uloga.Klijent || 
                    korisnik.getUloga()== Uloga.Moderator || korisnik.getUloga()== Uloga.Urednik) 
            {
                return true;
            }
        }
